# Django settings for grimm project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'grimm.db',                      # Or path to database file if using sqlite3.
...
# MEDIA_URL = ''
MEDIA_URL = path.join(STATIC_DOC_ROOT, 'media/')
...
SECRET_KEY = 're502^06(ygji0n7uj)la01cj((pq&shcktmx2tkw*@m-60i0m'
...
WSGI_APPLICATION = 'grimm.wsgi.application'
...
INSTALLED_APPS = (
    ...
    'django.contrib.sites',
     #flatpages for the presentations
